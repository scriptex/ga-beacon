...
This package allows you to track your visitors by inserting an image in your document (any HTML or Markdown page).
...
This module lives as serverless Node JS function deployed to Vercel. It can be found on https://ga-beacon.atanas.info.
